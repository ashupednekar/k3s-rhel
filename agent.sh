...
curl -sfL https://get.k3s.io | K3S_URL="https://${MASTER_IP}:6443" K3S_TOKEN="${NODE_TOKEN}" INSTALL_K3S_EXEC="--flannel-backend=none --node-ip=${AGENT_IP} --node-external-ip=${AGENT_IP}" sh -
